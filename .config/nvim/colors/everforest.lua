...
if vim.o.background == 'light' then
  ...
  hi('Statement',        { fg = draw.Text, bold = true,                 cterm = { bold = true } })
  hi('PreProc',          { fg = draw.Text, underline = true,            cterm = { underline = true } })
  hi('Type',             { fg = draw.Text, bold = true,                 cterm = { bold = true } })
  hi('Underlined',       { fg = 'SlateBlue', underline = true,          cterm = { underline = true } })
