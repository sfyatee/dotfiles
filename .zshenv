...
export BROWSER CVS_RSH EDITOR GOT_AUTHOR GOTELEMETRY GOTOOLCHAIN GS_FONT_PATH\
    DO_NOT_TRACK HISTFILE LESSHISTFILE MYSQL_HISTFILE PYTHON_HISTORY TF2 H\
    LC_CTYPE LC_COLLATE LC_TIME XDG_CACHE_HOME XDG_CONFIG_HOME XDG_DATA_HOME\
    NO_COLOR AV_LOG_FORCE_NOCOLOR CARGO_HOME CUDA_CACHE_PATH RUSTUP_HOME\
    PAGER PATH PLAN9 PS1 NPROC MAKEFLAGS SAMUFLAGS CMAKE_COLOR_MAKEFILE=OFF\
    CLAUDE_CONFIG_DIR CODEX_HOME COPILOT_HOME OLLAMA_MODELS\
    PACMAN_AUTH SYSTEMD_RUN_SHELL_PROMPT_PREFIX\
    NAMESPACE font font2 secstore home prompt user\
