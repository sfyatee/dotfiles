...
export BROWSER DO_NOT_TRACK EDITOR GOT_AUTHOR GOTELEMETRY GOTOOLCHAIN\
    GS_FONT_PATH HISTFILE LANG LC_CTYPE LC_COLLATE LC_TIME LESS PAGER PATH\
    PLAN9 PS1 NAMESPACE NO_COLOR NPROC MAKEFLAGS SAMUFLAGS TF2\
    CLAUDE_CONFIG_DIR CODEX_HOME COPILOT_HOME OLLAMA_MODELS PACMAN_AUTH\
    SYSTEMD_RUN_SHELL_PROMPT_PREFIX font font2 secstore home prompt user\
